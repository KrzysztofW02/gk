...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		...
		szesnastokat(g2, 100, -1.02, -0.05);
		szesnastokat(g2, 100, 1.04, -0.98);
		szesnastokat(g2, 80, -1.379, 1.40);
		szesnastokat(g2, 80, -3.13, 2.23);
		szesnastokat(g2, 60, 0.9, 2.05);
		szesnastokat(g2, 60, 2.12, 1.45);

		ScProstokat(g2,1,1.05, 0, -0.5, Color.RED);
		ScProstokat(g2,0.85,0.95, -2.65, 1.90,Color.RED);
		ScProstokat(g2,0.6,0.70, 2.5, 2.5,Color.RED);

		Trojkat(g2 ,0.5,0.5,0,-2,Color.BLUE);
		Trojkat(g2 ,0.35,0.35,-2.25,0.75,new Color(128, 0, 128));
		Trojkat(g2 ,0.25,0.25, 1.5,1, Color.GREEN);
	} // end drawWorld()

	private void ScProstokat (Graphics2D g2,double x , double y, double translate_x ,double translate_y, Color color)
	{
		AffineTransform saveTransform = g2.getTransform();
		g2.scale(x,y);
		Prostokat(g2, translate_x, translate_y);
		g2.setTransform(saveTransform);
	}
	private void Prostokat (Graphics2D g2, double translate_x ,double translate_y  )
	{
	...
	private void Trojkat (Graphics2D g2,double x , double y, double translate_x ,double translate_y ,Color color)
	{
		AffineTransform saveTransform = g2.getTransform();
		g2.setColor(color);
		g2.translate(translate_x,translate_y);
	...
	private void szesnastokat(Graphics2D g2,double r, double translate_x ,double translate_y)
	{
		AffineTransform saveTransform = g2.getTransform();
