...
public class SceneGraph extends JPanel {
	...
	// (DELETE THIS EXAMPLE)
		...
		private TransformedObject P1,P2,P3; 
		private TransformedObject  S1,S2,S3,S4,S5,S6; 
	/**
	...
	private void createWorld() {
		...
		T2.setScale(0.5,1).setTranslation(-2.25,0.5).setColor(new Color(128, 0, 128));
		world.add(T2);
		T3 = new TransformedObject((filledTriangle));
		T3.setScale(0.5, 0.8).setTranslation(1.5, 1).setColor(Color.GREEN);
		world.add(T3);
		P1 = new TransformedObject(filledRect);
		P1.setRotation(-22.5).setScale(2, 0.1).setTranslation(0, -0.8).setColor(Color.RED);
		world.add(P1);
		P2 = new TransformedObject(filledRect);
		P2.setRotation(-22.5).setScale(1.8, 0.1).setTranslation(-2.2, 1.50).setColor(Color.RED);
		world.add(P2);
		P3 = new TransformedObject(filledRect);
		P3.setRotation(-22.5).setScale(1.5, 0.08).setTranslation(1.5, 1.8).setColor(Color.RED);
		world.add(P3);
		S1 = new TransformedObject(szesnastokat);
		S1.setScale(0.3, 0.3).setTranslation(-0.889, -0.42);
		world.add(S1);
		S2 = new TransformedObject(szesnastokat);
		S2.setScale(0.3, 0.3).setTranslation(0.899, -1.189);
		world.add(S2);
		S3 = new TransformedObject(szesnastokat);
		S3.setScale(0.25, 0.25).setTranslation(-3, 1.825);
		world.add(S3);
		S4 = new TransformedObject(szesnastokat);
		S4.setScale(0.25, 0.25).setTranslation(-1.4, 1.18);
		world.add(S4);
		S5 = new TransformedObject(szesnastokat);
		S5.setScale(0.2, 0.2).setTranslation(0.83, 2.07);
		world.add(S5);
		S6 = new TransformedObject(szesnastokat);
		S6.setScale(0.2, 0.2).setTranslation(2.16, 1.52);
		world.add(S6);
	} // end createWorld()
	...
	public void updateFrame() {
		frameNumber++;
		S1.setRotation(frameNumber);
		S2.setRotation(frameNumber);
		S3.setRotation(frameNumber);
		S4.setRotation(frameNumber);
		S5.setRotation(frameNumber);
		S6.setRotation(frameNumber);
	}
	...
	private static SceneGraphNode szesnastokat = new SceneGraphNode()
	{void doDraw(Graphics2D g){
		int n=16;
		double t=0;
